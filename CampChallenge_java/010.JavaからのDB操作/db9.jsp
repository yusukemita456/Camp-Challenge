...
letter-spacing: 0.3em; /* 文字間のスペース */
    ...
    <body>
        <P>
            ...
            ようこそ！　ここではID、名前、電話番号、年齢、生年月日が挿入できます。
            
        
        
        </P>  
        <form action="/JAVADATABASE/db_9" method="POST">  
            
        ID?
        <input type="text" name="profilesID" value="34" class="textBox"  ><br>
        名前？
        <input type="text" name="namae" value="沖田信二" class="textBox"><br>
        電話？
        <input type="text" name="tell" value="08099999" class="textBox"><br>
        いくつ？
